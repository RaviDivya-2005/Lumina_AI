...
function ProtectedRoute({ children, roles }) {
  ...
  if (isLoading) return <div className="min-h-screen bg-slate-50 dark:bg-gray-950 flex items-center justify-center"><div className="w-8 h-8 border-2 border-indigo-600 dark:border-white border-t-transparent rounded-full animate-spin" /></div>
